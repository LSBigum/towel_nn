...
for imagePath in imagePaths:
    ...
    #print(label)
    if label == "images/True":
        label = True
    elif label == "images/False": 
        label = False
    labels.append(label)
    #print(imagePath)
...
aug = ImageDataGenerator(rotation_range=40, width_shift_range=0.2, height_shift_range=0.2, 
